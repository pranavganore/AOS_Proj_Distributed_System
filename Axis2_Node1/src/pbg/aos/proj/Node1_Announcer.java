...
/**
 * Servlet implementation class Node1_Announcer
 */
public class Node1_Announcer extends HttpServlet {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag1!=1 || counter1 != 10) {
	    			try {
	    				System.out.println("Node1_Announcer >> Main Registery server NOT reachable! Will try again after 20 Seconds!!");
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag2!=1 || counter2 != 10) {
	    			try {
	    				System.out.println("Node1_Announcer >> Registery Server Replica 1 NOT reachable! Will try again after 20 Seconds!!");
	    				Thread.sleep(1000*20);
	    				//init_announce();
	    				System.out.println("Trying to announce again after 20sec");
	    			} catch (InterruptedException e) {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag3!=1 || counter3 != 10) {
	    			try {
	    				System.out.println("Node1_Announcer >> Registery Server Replica 2 NOT reachable! Will try again after 20 Seconds!!");
	    				Thread.sleep(1000*20);
	    				//init_announce();
	    				//System.out.println("Trying to announce again after 20sec");
	    			} catch (InterruptedException e) {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	        	if(flag1 == 0 && flag2 == 0 && flag3 == 0) {
	        		System.out.println("Node1_Announcer >> No Registery servers are reachable!! Thus ShuttingDown!!");
	        	}
	...
	public void announcetoallRS(String RSURL) {
		...
		try {	
			...
			String msg =  "{\"Server_Name\": \"Node1\", \"Services\": {\"Addition\": \"http://"+IPAddr+":8081/Axis2_Node1/services/Addition_Service?wsdl\",\"Multiplication\": \"http://"+IPAddr+":8081/Axis2_Node1/services/Multiplication_Service?wsdl\",\"Echo\": \"http://"+IPAddr+":8081/Axis2_Node1/services/Echo_Service?wsdl\"}}";
			...
			//e.printStackTrace();
			  System.out.println("Node1_Announcer >> "+RSURL+" NOT Reachable!!!");
	...
	public void destroy() {		
		...
		System.out.println("Notified all live Registery Servers!! Now shutting down!!");
