...
/**
 * Servlet implementation class Node3_Announcer
 */
public class Node3_Announcer extends HttpServlet {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag1!=1 || counter1 != 10) {
	    			try {
	    				System.out.println("Node3_Announcer >> Main Registery server NOT reachable! Will try again after 20 Seconds!!");
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag2!=1 || counter2 != 10) {
	    			try {
	    				System.out.println("Node3_Announcer >> Registery Server Replica 1 NOT reachable! Will try again after 20 Seconds!!");
	    				Thread.sleep(1000*20);
	    				//init_announce();
	    				System.out.println("Trying to announce again after 20sec");
	    			} catch (InterruptedException e) {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag3!=1 || counter3 != 10) {
	    			try {
	    				System.out.println("Node3_Announcer >> Registery Server Replica 2 NOT reachable! Will try again after 20 Seconds!!");
	    				Thread.sleep(1000*20);
	    				//init_announce();
	    				System.out.println("Trying to announce again after 20sec");
	    			} catch (InterruptedException e) {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	        	if(flag1 == 0 && flag2 == 0 && flag3 == 0) {
	        		System.out.println("Node3_Announcer >> No Registery servers are reachable!! Thus ShuttingDown!!");
	        	}
	...
	public void announcetoallRS(String RSURL) {
		...
		try {	
			...
			String msg =  "{\"Server_Name\": \"Node3\", \"Services\": {\"Division\": \"http://"+IPAddr+":8083/Axis2_Node3/services/Division_Service?wsdl\",\"Reverse\": \"http://"+IPAddr+":8083/Axis2_Node3/services/Reverse_Service?wsdl\",\"Echo\": \"http://"+IPAddr+":8083/Axis2_Node3/services/Echo_Service?wsdl\"}}";
			...
			//e.printStackTrace();
			  System.out.println("Node3_Announcer >> "+RSURL+" NOT Reachable!!!");
