...
/**
 * Servlet implementation class Node5_Announcer
 */
public class Node5_Announcer extends HttpServlet {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag1!=1 || counter1 != 10) {
	    			try {
	    				System.out.println("Node5_Announcer >> Main Registery server NOT reachable! Will try again after 20 Seconds!!");
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag2!=1 || counter2 != 10) {
	    			try {
	    				System.out.println("Node5_Announcer >> Registery Server Replica 1 NOT reachable! Will try again after 20 Seconds!!");
	    				Thread.sleep(1000*20);
	    				//init_announce();
	    				System.out.println("Trying to announce again after 20sec");
	    			} catch (InterruptedException e) {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	    		...
	    		while(flag3!=1 || counter3 != 10) {
	    			try {
	    				System.out.println("Node5_Announcer >> Registery Server Replica 2 NOT reachable! Will try again after 20 Seconds!!");
	    				Thread.sleep(1000*20);
	    				//init_announce();
	    				System.out.println("Trying to announce again after 20sec");
	    			} catch (InterruptedException e) {
	    ...
	    new java.util.Timer().schedule(new java.util.TimerTask() {
	        ...
	        public void run() {
	        	if(flag1 == 0 && flag2 == 0 && flag3 == 0) {
	        		System.out.println("Node5_Announcer >> No Registery servers are reachable!! Thus ShuttingDown!!");
	        	}
	...
	public void announcetoallRS(String RSURL) {
		...
		try {	
			...
			String msg =  "{\"Server_Name\": \"Node5\", \"Services\": {\"Reverse\": \"http://"+IPAddr+":8085/Axis2_Node5/services/Reverse_Service?wsdl\",\"GCD\": \"http://"+IPAddr+":8085/Axis2_Node5/services/GCD_Service?wsdl\",\"LCM\": \"http://"+IPAddr+":8085/Axis2_Node5/services/LCM_Service?wsdl\"}}";
			...
			//e.printStackTrace();
			  System.out.println("Node5_Announcer >> "+RSURL+" NOT Reachable!!!");
